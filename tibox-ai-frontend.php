 ...
 */
define('TIBOX_AI_FRONTEND_VERSION', '0.3.0-dev');
...
// Core heredado del MVP de página completa. Se mantiene temporalmente.
require_once TIBOX_AI_FRONTEND_DIR . 'includes/class-tibox-ai-frontend.php';

// Constructor HUB: componentes reutilizables + renderer híbrido.
